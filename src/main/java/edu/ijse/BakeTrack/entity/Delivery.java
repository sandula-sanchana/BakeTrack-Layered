...
public class Delivery {
    ...
    public Delivery(int delivery_id, int vehicle_id, int employee_id, LocalDate delivery_date, String area) {
    ...
    public Delivery(int vehicle_id, LocalDate delivery_date, String area) {
        this.vehicle_id = vehicle_id;
        this.delivery_date = delivery_date;
        this.area = area;
    }
