...
public class Ingredient {
    ...
    public Ingredient(int ingredient_id, String name, int stock_amount, String unit, double buying_price, LocalDate expire_date) {
    ...
    public Ingredient(String name, int stock_amount, String unit, double buying_price, LocalDate expire_date) {
        this.name = name;
        this.stock_amount = stock_amount;
        this.unit = unit;
        this.buying_price = buying_price;
