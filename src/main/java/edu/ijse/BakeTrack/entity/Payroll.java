...
public class Payroll {
    ...
    public Payroll(int payroll_id, int employee_id, LocalDate pay_Date, double over_time_hours, double base_salary, double full_salary, String status) {
    ...
    public Payroll(int employee_id, LocalDate pay_Date, Double over_time_hours, double base_salary, double full_salary, String status) {
        this.employee_id = employee_id;
        this.pay_Date = pay_Date;
        this.over_time_hours = over_time_hours;
        this.base_salary = base_salary;
