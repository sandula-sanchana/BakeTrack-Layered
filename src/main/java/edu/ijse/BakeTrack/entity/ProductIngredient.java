...
public class ProductIngredient {
    ...
    public ProductIngredient(int id, int product_id, int ingredient_id, int quantity_per_product, String unit) {
        this.id = id;
    ...
    public ProductIngredient(int product_id, int ingredient_id, int quantity_per_product, String unit) {
        this.product_id = product_id;
        this.ingredient_id = ingredient_id;
        this.quantity_per_product = quantity_per_product;
        this.unit = unit;
